...
export const metadata: Metadata = {
  ...
  description: 'Signalisation temporaire, permanente et matériel de chantier. Signaux pliants Triopan, cônes, barrières, panneaux OSR, miroirs et équipements de sécurité routière.',
...
const permProducts = [
  ...
  { img: '/images/Liste produit/Mise à ban.jpeg',          name: 'Mise à ban',               desc: 'Fabrication et installation de signaux de mise à ban pour accès privés, parkings et sites réservés.' },
]
...
const securiteProducts = [
  ...
  { img: '/images/travaux-ralentisseurs.jpg',                  name: 'Ralentisseurs',         desc: "Dos-d'âne et coussins berlinois pour réduire la vitesse dans les zones sensibles." },
]
  ...
  return (
    <>
      <Hero
        ...
        badge="Nos produits"
        title={<>Nos produits de <span className="text-red">signalisation et sécurité routière</span></>}
        subtitle="Une gamme complète pour le balisage, la signalisation permanente et la sécurité routière."
      ...
      <section className="section-pad bg-bg-light" aria-label="Signalisation permanente">
        <div className="container">
          <SectionHeader
            ...
            title={<>Panneaux permanents & <span className="text-red">signaux OSR</span></>}
      ...
      <section className="section-pad" aria-label="Sécurité et mobilier urbain">
        <div className="container">
          <SectionHeader
            ...
            subtitle="Équipements pour réduire la vitesse, guider les usagers et protéger les zones sensibles."
          />
      ...
      <section className="section-pad bg-bg-light" aria-label="Matériel de chantier et balisage">
        <div className="container">
          <SectionHeader
            ...
            subtitle="Lattes, lampes et supports pour organiser et sécuriser vos zones de chantier."
          />
